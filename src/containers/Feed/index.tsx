    ...
    <>
      <div className="flex flex-col">
        ...
        <div className="block md:grid md:grid-cols-12 gap-6">
          <div className="lg:mt-5 top-[200px] hidden lg:block col-span-2">
            <Cards.ProfileCard />
            <div
              className="common-no-scroll-bar sticky mt-10 top-[81px] hidden lg:block overflow-scroll"
              style={{
          ...
          <div className="col-span-12 lg:col-span-10 lg:mt-10">
