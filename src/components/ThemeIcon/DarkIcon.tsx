const DarkIcon: React.FC = () => {
    return (
      <>
      <div className={`box-sizing:content-box hover:rounded-full hover:bg-gray-900 dark:hover:bg-sky-900 p-2`}>
        <svg role="img" viewBox="0 0 24 24" height="1em" fill="white" xmlns="http://www.w3.org/2000/svg">
